...
#     f"{save_dir}/enumerate(dataloader_val):model_30.pth", map_location=device))
# nn_model.train()
...
def sample_ddpm_context(n_sample, layout, save_rate=20):
    ...
    for i in range(timesteps, 0, -1):
        ...
        eps = nn_model(samples, t, c=None,layout=None,layout_concate=layout)    # predict noise e_(x_t,t, ctx)
...
nn_model.load_state_dict(torch.load(
    f"{save_dir}/model_{840}.pth", map_location=device))
nn_model.eval()
